...
### 2. Crie um arquivo chamado main.tf e adicione o seguinte conteúdo:
...
### 3. Inicie um novo diretório Terraform com o comando:
...
### 4. Visualize as alterações que o Terraform fará na infraestrutura com o comando:
...
### 5. Crie a máquina virtual na AWS com o comando:
...
### 6. Aguarde o Terraform concluir a criação da máquina virtual.
...
### 7. Adicionando o certificado SSH
...
### 8. Destruindo a instância criada
